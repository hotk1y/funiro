                ...
                !(function (e) {
                  ...
                  e.products.forEach((e) => {
                    ...
                    (f = '<div class="item-product__prices">'),
                      (f += `<div class="item-product__price">Rp ${l}</div>`),
                      o &&
                        (f += `<div class="item-product__price item-product__price_old">Rp ${o}</div>`),
                      (f += "</div>");
                    let g = "";
                    (g += '<div class="item-product__body">'),
                      (g += `\n\t\t<div class="item-product__content">\n\t\t\t<h3 class="item-product__title">${r}</h3>\n\t\t\t<div class="item-product__text">${a}</div>\n\t\t</div>\n\t`),
                      (g += f),
                      (g += `\n\t\t<div class="item-product__actions actions-product">\n\t\t\t<div class="actions-product__body">\n\t\t\t\t<a href="" class="actions-product__button button">Add to cart</a>\n\t\t\t\t<a href="${d}" class="actions-product__link"><img src="img/iconsfont/share.svg"alt="">Share</a>\n\t\t\t\t<a href="${c}" class="actions-product__link"><img src="img/iconsfont/favorite.svg"alt="">Like</a>\n\t\t\t</div>\n\t\t</div>\n\t`),
                      (g += "</div>");
                    let v = "";
                    (v += u),
                      (v += m),
        ...
        i.addEventListener("mousemove", function (e) {
          ...
          (r = (s / t) * 200),
            i.classList.contains("_init") ||
              (requestAnimationFrame(a), i.classList.add("_init"));
        });
      }
    }),
    (window.FLS = !0),
